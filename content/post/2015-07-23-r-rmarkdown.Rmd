...
Within the curly braces, you can name your code chunk. I named our first code chunk "headCars". In addition, you pass *options*. The option parameters tell R what R should do with the code snippet. For example you can tell R to only show the results without the code by passing the option `echo = FALSE` like this:
...
Here is a brief overview of the options, I use the most. You can use as many options, as you like. The order of options does not matter, but you have to separate them with a comma.
...
Still not very pretty. One quick and simple way to create nicer looking tables is by using the `kable` function from the knitr package.
