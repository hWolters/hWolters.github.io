...
tags: ["Hiring", "Engineering Leadership", "Engineering Management", "Team Culture"]
draft: false
featured: false
---
...
A Director interview should not repeat those conversations. I want to reduce a different kind of uncertainty.
...
At that point we are no longer talking about compensation. We are talking about how someone approaches an ambiguous situation.
...
I never expect candidates to arrive at the same conclusion I would. I want to understand what information they consider important before making a decision.

## Understand the person behind the resume

Most of my interviews feel more like conversations than questionnaires. We often spend time talking about previous teams, companies, and projects. I am trying to understand the person behind those experiences.
...
I remember discussing a test suite that had grown to roughly seventy automated tests but still took around two hours to execute. We ended up talking about bottlenecks, architecture, and why this had become a meaningful engineering problem. I was not evaluating whether every technical decision was perfect. I wanted to see whether the candidate could make me understand why the problem mattered and how they thought about solving it.
...
Those discussions are often the most enjoyable part of the interview. Strong candidates don't become defensive. They explain their reasoning, acknowledge trade-offs, consider alternative viewpoints, and have an interesting conversation with me. The ability to reason collaboratively is what matters here, not the actual solution.
